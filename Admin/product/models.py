...
class productModel(models.Model):
    ...
    pro_back_image = models.ImageField(upload_to = 'Admin/ProductImage/Back',default='default.jpg', null = True, blank = True)
    feature_image = models.ImageField(upload_to = 'Admin/ProductImage/Feature',default='default.jpg', null = True ,blank=True)
