...
class productModel(models.Model):
    ...
    catname_id = models.ForeignKey(categoryModel, on_delete = models.CASCADE,null=True)
    ...
    pro_image = models.ImageField(upload_to = 'Admin/ProductImage/Main',
        null = True ,blank=True  )
    pro_back_image = models.ImageField(upload_to = 'Admin/ProductImage/Back', null = True, blank = True)
    feature_image = models.ImageField(upload_to = 'Admin/ProductImage/Feature', null = True ,blank=True)